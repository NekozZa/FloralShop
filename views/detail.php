<?php 
    ...
    $productReviews = getProductReviews($conn, $productID);
    $randomProductsByCategory = getRandomProductsByCategory($conn, $product['CategoryID'], 8);

    if (isset($_SESSION['UserID'])) {
        $isOwner = isOwner($conn, $productID);
    }

    function isOwner($conn, $productID) {
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center quantity" value="1">
                        ...
                        <button 
                            class="btn btn-primary px-3 add-item-btn" 
                            onclick="addItemByQuantity(<?= $product['ProductID'] ?>)"
                        >
                                    ...
                                    <?php foreach ($productReviews as $review) { ?>
                                        <div class="media mb-4">
                                            <div class="media-body">
                                                <h6><?= $review['Username'] ?><small> - <i><?= $review['CreateDate'] ?></i></small></h6>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group mb-0">
                                                    <button 
                                                        class="btn btn-primary add-comment-btn px-3" 
                                                        onclick="addComment(<?= $productID ?>)"
                                                    >
                                                        Leave Your Review
                                                    </button>
                                                </div>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    <?php foreach($randomProductsByCategory as $product) { ?>
